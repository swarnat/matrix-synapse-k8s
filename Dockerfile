...
RUN pip install --no-deps --no-warn-script-location boto3 botocore humanize jmespath s3transfer tqdm typing-extensions && mkdir -p /data/media/local_content && chmod 777 /data/media/local_content
